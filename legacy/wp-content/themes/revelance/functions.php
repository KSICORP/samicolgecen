...
if ( ! function_exists( 'ABdev_revelance_scripts' ) ){
	function ABdev_revelance_scripts() {
		...
		wp_enqueue_style('entypo_icons', TEMPPATH.'/css/entypo.css');
		...
		wp_enqueue_script( 'revelance_custom', TEMPPATH.'/js/custom.js', array( 'inview','superfish','placeholder','jpreloader','waypoints','knob','isotope','masonry','imagesloaded','fancybox','google_maps_jquery' ),'', true );
